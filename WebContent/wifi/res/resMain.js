...
com.wifi.ResMain=Ext.extend(Ext.Viewport,
   {
	 //视图构造函数
	 constructor: function() {
		...
		com.wifi.ResMain.superclass.constructor.call(this, {
			enableTabScroll:true,
			layout:"fit",
			id:"mainViewportId",
			autoDestroy:true,
	...
	//
    north:function(){
    	return new com.wifi.ResQryForm({
    		id:"qryFrmId",
			region:"north",
			autoHeight:true,
			title:"查询条件",
    ...
    //
	center:function(){
		return new com.wifi.ResRstGrid({			
			region:"center",
			title:g_type_zh+"面板列表",
