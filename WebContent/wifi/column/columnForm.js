...
//编辑主表单定义
com.yst.wifi.ColumnForm = Ext.extend(Ext.ux.BaseForm,{
	    isDisabled:false,
		getItems : function() {
		return [{
				  frame:false,
				  ...
				  items:[					      
						{layout : 'column',items : [
								{layout:'form',columnWidth : 0.25,labelAlign : 'right',labelWidth : 70,items:[
									   {
										   disabled:this.isDisabled,xtype:"hidden",name:"columnId",id:"columnId",anchor:"100%"
								       },{
										   disabled:this.isDisabled,xtype:"hidden",name:"parentColumnId",id:"parentColumnId",anchor:"100%"
								       },{
										   disabled:this.isDisabled,xtype:"hidden",name:"custId",id:"custId",anchor:"100%"
								       },
//								       {
//										   disabled:this.isDisabled,xtype:"hidden",name:"createMan",id:"createMan",anchor:"100%"
//								       },
								       {
										   disabled:this.isDisabled,xtype:"hidden",name:"defaultFlag",id:"defaultFlag",anchor:"100%"
								       }
									]
