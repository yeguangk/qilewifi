...
com.wifi.CustQryForm = Ext.extend(Ext.ux.BaseForm,
		{
				...
				return [ 
					...
					{layout : 'column',items : [
					        {layout:'form',columnWidth : 0.25,labelAlign : 'right',labelWidth : 70,items:[
									   {
											 xtype:'baseComBox',fieldLabel:"店面",name:"cilentId",id:"cilentIdQry",
											 hiddenName:"cilentId",
			...
			buildButtons3 : function() {
				return [ {
					width : 60,
					xtype : 'button',
					text : '按小时',
					 style:"margin-top:-5px;",
					handler : this.hourQryBtnFun.createDelegate(this)
				}, {
					width : 60,
					xtype : 'button',
					text : '按天',
					 style:"margin-top:-5px;",
					handler : this.dayQryBtnFun.createDelegate(this)
				}, {
					width : 60,
					xtype : 'button',
					text : '按月',
					 style:"margin-top:-5px;",
					handler : this.monthQryBtnFun.createDelegate(this)
				}];
			},
			hourQryBtnFun : function() {
				
			},
			dayQryBtnFun : function() {
				
			},
			monthQryBtnFun : function() {
